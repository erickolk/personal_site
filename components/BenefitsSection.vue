    ...
    <div class="container-custom">
      ...
      <div class="text-center mb-16" data-aos="fade-up" data-aos-duration="1000">
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto">
          Descubra os diferenciais que fazem de mim o personal trainer ideal para sua transformação
        </p>
      </div>
      ...
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
        ...
        <div class="bg-white rounded-2xl p-8 text-center card-hover" data-aos="fade-up" data-aos-delay="100">
          ...
          <p class="text-gray-600 leading-relaxed">
            Cada treino e plano alimentar é desenvolvido especificamente para você, considerando suas limitações, 
            objetivos e estilo de vida único.
          </p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 text-center card-hover" data-aos="fade-up" data-aos-delay="200">
          ...
          <p class="text-gray-600 leading-relaxed">
            Estou sempre disponível para tirar suas dúvidas, ajustar treinos e te motivar. 
            Suporte completo via WhatsApp todos os dias da semana.
          </p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 text-center card-hover" data-aos="fade-up" data-aos-delay="300">
          ...
          <p class="text-gray-600 leading-relaxed">
            95% dos meus alunos alcançam seus objetivos nos primeiros 3 meses. 
            Se você seguir o plano, os resultados são garantidos!
          </p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 text-center card-hover" data-aos="fade-up" data-aos-delay="400">
          ...
          <p class="text-gray-600 leading-relaxed">
            Mais de 5 anos transformando vidas, com certificações atualizadas e 
            métodos cientificamente comprovados para máxima eficiência.
          </p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 text-center card-hover" data-aos="fade-up" data-aos-delay="500">
          ...
          <p class="text-gray-600 leading-relaxed">
            Não cuido apenas do seu corpo, mas da sua mente e motivação. 
            Acompanhamento psicológico e emocional durante toda a jornada.
          </p>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 text-center card-hover" data-aos="fade-up" data-aos-delay="600">
          ...
          <p class="text-gray-600 leading-relaxed">
            App exclusivo para acompanhar treinos, progressos e receber orientações. 
            Tudo na palma da sua mão, simples e prático.
          </p>
        </div>
      </div>
      ...
      <div class="bg-gradient-to-r from-orange-500 to-black rounded-2xl p-8 text-center text-white mb-16" data-aos="fade-up" data-aos-delay="700">
        <div class="max-w-4xl mx-auto">
          <div class="flex items-center justify-center mb-4">
            ...
            <h3 class="text-3xl font-bold">Atenção: Vagas Limitadas!</h3>
          </div>
          
          <p class="text-xl mb-6 opacity-90">
            Para garantir a qualidade do atendimento, aceito apenas <strong>10 novos alunos por mês</strong>
          </p>

          <!-- Countdown Timer -->
          <div class="bg-white/20 rounded-xl p-6 mb-6">
            <div class="text-lg mb-4">Inscrições para este mês fecham em:</div>
            <div class="grid grid-cols-4 gap-4 max-w-md mx-auto">
              <div class="bg-white/30 rounded-lg p-3">
                <div class="text-2xl font-bold">07</div>
                <div class="text-sm opacity-90">Dias</div>
              </div>
              <div class="bg-white/30 rounded-lg p-3">
              ...
              <div class="bg-white/30 rounded-lg p-3">
                ...
                <div class="text-sm opacity-90">Min</div>
              </div>
              <div class="bg-white/30 rounded-lg p-3">
                <div class="text-2xl font-bold">18</div>
                <div class="text-sm opacity-90">Seg</div>
              </div>
            </div>
          </div>
          ...
          <div class="mb-6">
            ...
            <div class="text-sm mt-2 opacity-90">Apenas 3 vagas restantes!</div>
          </div>
